#include "Engine/Asset/StaticMeshSection.hpp"
#include "Engine/Core/Engine.hpp"
#include "Engine/Renderer/IndexBuffer.hpp"   // destructor
#include "Engine/Renderer/VertexBuffer.hpp"  // destructor
...
//-----------------------------------------------------------------------------------------------
void StaticMeshSection::CreateVertexBuffer()
{
...
//-----------------------------------------------------------------------------------------------
void StaticMeshSection::CreateIndexBuffer()
{
