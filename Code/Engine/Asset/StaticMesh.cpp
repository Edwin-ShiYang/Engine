...
//-----------------------------------------------------------------------------------------------
void StaticMesh::Render( std::vector< Node > const& nodes, std::vector< Material > const& materials, Mat44 const& modelToWorldTransform, Mat44 const& toEngineMatrix ) const
{
    Mat44 m = modelToWorldTransform;
    m.Append( toEngineMatrix );
